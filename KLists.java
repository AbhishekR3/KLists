...
public class KLists{
	...
	public static double[] mergeKLists(double[][] bigArray){
		...
		// Counts number of elements in outer array to set value for single array
		...
		// Places outer array vaues into single array
		int i = 0;
